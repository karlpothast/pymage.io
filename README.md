...
![alt text](https://raw.githubusercontent.com/karlpothast/pymage.io/master/documentation/extracted_text.png)

### Then click the copy text button on the right to paste the extracted text wherever you need it. 
![alt text](https://raw.githubusercontent.com/karlpothast/pymage.io/master/documentation/copy.png)

### In this case pycharm, the software the insructor is using for the tutorial.
